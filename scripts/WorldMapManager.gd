...
# Map scene resources
const Map1 = preload("res://scenes/maps/map_1.tscn")
const Map2 = preload("res://scenes/maps/map_2.tscn")
const ObstacleCourse1P = preload("res://scenes/maps/obstable_course_1p.tscn")
const ObstacleCourse1P2 = preload("res://scenes/maps/obstable_course_1p2.tscn")
